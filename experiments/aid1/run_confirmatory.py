...
from experiments.aid1.scoring import evaluate, evaluate_criterion, semantic_hash

ROOT = Path(__file__).resolve().parents[2]
PINNED = {
    "experiments/aid1/PREREGISTRATION.md": "b555a256bd101e84f197137b0abb0b5a43c0beae0ba4552641c13ed225cf984b",
    "experiments/aid1/CONFIRMATORY-CONFIG.json": "e762a1384c9aea486ff15b6ccfae2b56a3bba4d8eb556b7197c8312ad64eb09a",
    "experiments/aid1/world.py": "b5cb965a12ddec6901280038ece8602c8504ecb4f4c9b6de3b3997e2ee1d82d9",
    "experiments/aid1/arms.py": "f5cb871c12033de55be34119939c74302c3bb7cfc2b196ad962db33c85546da6",
    "experiments/aid1/scoring.py": "23a0424c2b714e667226447db323dba5b3e194ff0ada9c2c583e0e6ee981cf44",
...
def load_config(root: Path = ROOT) -> dict[str, Any]:
    verify_pins(root)
    config = json.loads((root / "experiments/aid1/CONFIRMATORY-CONFIG.json").read_text())
    ...
    if config["success_criterion"]["primary"] != "attested":
        raise ValueError("AID-1 primary is not attested")
    return config
