...
| DRI-9-V1 | Canonical intervention experiment: rejected | `results/dri9-v1/canonical-manifest.json` | The method named before the run, a ladder requiring two signals to agree, cleared its 25% effect floor in 1 of 8 powered cells: most precise arm (0–6 false merges, no correct settlement lost) and least useful. Bait, a reported arm, cleared it in 8 of 8 at 34–77%. The decoy family planted no markers, so bait's zero-merge "no harm" pass did not test the instrument; see DRI-10. Reflection cleared the floor while making 6,497–8,782 false merges per cell. Reversible decisions only; synthetic; same control domain. |
