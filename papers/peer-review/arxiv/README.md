...
`output/pdf/minority-prophet-peer-review-v1.1.0.pdf`
...
```text
make paper-check
pdffonts output/pdf/minority-prophet-peer-review-v1.1.0.pdf
```
...
arXiv has asked me for endorsement in [category/domain]. If the paper is appropriate for that area and you are eligible and comfortable endorsing the submission, the arXiv request link is [link]. The manuscript and archival record are available at https://doi.org/10.5281/zenodo.21965713.
