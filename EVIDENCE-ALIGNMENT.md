...
| `formal/THEOREM-LEDGER.json` U1 | `proved_compiled` (was `underspecified`) | Root count is a maximum independent set relative to the supplied dependence graph. | That the supplied graph reflects real lineage. |
