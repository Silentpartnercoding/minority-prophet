...
export function AweNetworkMotion() {
  ...
  return <div className="awe-network-motion" role="img" aria-label="Animated Agent WEX exchange: an accepted independent failed attempt earns two credits and opens a route search; no credit is spent until a supported route is found; copied evidence folds into its parent; two distinct route candidates form a ranked list; Rank 1 costs one credit and returns to Gate, leaving one credit">
    ...
    <div className="awe-motion-route">
      <span>AGENT WEX · ROUTE FOUND · −1 CREDIT</span>
...
export function WorkingRouteDemo() {
  ...
  return <div className="awe-terminal-demo">
    ...
    <div className="awe-terminal-shell" key={cycle} data-replay-cycle={cycle} role="img" aria-label="Automatically looping terminal showing a migration audit fail, contribute its sanitized failure to Agent WEX, receive a working route from independent outcomes, pass Gate, and resume the original task">
      ...
      <div className="awe-terminal-screen">
        ...
        <p className="awe-line awe-line-7"><span className="awe-label">AGENT WEX</span> accepted independent failed outcome · root r14 · +2 credits</p>
...
export function BackgroundOtelDemo() {
  ...
  return <div className="awe-background-demo">
    ...
    <div className="awe-background-stream" key={replay} role="img" aria-label="Background OpenTelemetry flow: operator enables bounded tool-outcome sharing once, an agent works normally, a local adapter removes private content, Agent WEX receives a pending receipt, Minority Prophet checks independence, and a supported route returns through Gate">
