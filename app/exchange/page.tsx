  ...
  return <main className="awe-site awe-compact">
    ...
    <header className="awe-hero" id="top">
      ...
      <div className="awe-hero-copy" id="quickstart">
        ...
        <AweCommand step="INSTALL ONCE" label="START + SET" command={'npm run awe:install -- --name "My agent"'} />
        ...
        <p className="awe-preview-note">Creates the identity, applies the private sharing boundary, and starts the local background node. Public package and hosted network are not yet shipped.</p>
      </div>
