#!/usr/bin/env python3
"""KL-018: pull each qualifying token's FULL history, then build the baseline."""
import json, os, random, time, urllib.request
SPEC=json.load(open(os.environ["KL018_SPEC"]))
...
cand=json.load(open("kl018_candidates.json"))
