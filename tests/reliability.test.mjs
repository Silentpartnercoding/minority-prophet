...
test("preflight detects outage and regression evidence before recommending a sealed route", () => {
...
test("network alerts expose aggregate compatibility evidence without node identities", () => {
