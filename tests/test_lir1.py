...
class LIR1Tests(unittest.TestCase):
    def test_case_set_digest_is_sorted_and_newline_terminated(self):
        expected = hashlib.sha256(b"a\nb\n").hexdigest()
        self.assertEqual(case_set_digest({"b", "a"}), expected)
    ...
    def test_mechanics_manifest_binds_every_file(self):
        ...
        for manifest_path in (
            ...
            "results/lir1-pheme-r2-v0.1/inventory-manifest.json",
            "results/lir1-pheme-r2-v0.1/result-manifest.json",
            "results/lir1-pheme-r2-v0.1/canonical-manifest.json",
            "results/lir1e-development-v0.1/manifest.json",
            "results/lir1e-confirmatory-v0.1/canonical-manifest.json",
            "results/lir2-development-v0.1/manifest.json",
