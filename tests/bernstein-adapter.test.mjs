...
import { bernsteinPluginSource, spansFromBernsteinEvents } from "../packages/awe-node/lib/bernstein.mjs";
import { adaptOtelSpanToRouteOutcome } from "../packages/awe-node/lib/receipt.mjs";
